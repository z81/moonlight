...
/***/ function(module, exports, __webpack_require__) {
	...
	var _component = __webpack_require__(276);
	...
	var App = function (_MoonLight) {
	    (0, _inherits3.default)(App, _MoonLight);
	    ...
	    (0, _createClass3.default)(App, [{
	        ...
	        value: function renderTodo(todo) {
	            ...
	            var save = function save() {
	                _this2.todos.update(todo); // send to server
	                todo.isEdit = false;
	            };
	            ...
	            return _react2.default.createElement(
	                'li',
	                { key: todo.id, className: className },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'view' },
	                    _react2.default.createElement('input', { type: 'checkbox', className: 'toggle', checked: !!todo.done, onChange: toggle }),
	                    _react2.default.createElement(
	                        'label',
	                        { onDoubleClick: edit },
	                        todo.text
	                    ),
	                    _react2.default.createElement('button', { className: 'destroy', onClick: todo.remove })
	                ),
	        ...
	        value: function renderFooter() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'ul',
	                    { className: 'filters' },
	                    (0, _keys2.default)(filters).map(function (name) {
	                        var props = {
	                            className: _this3.state.filter === name ? 'selected' : '',
	                            onClick: _this3.setFilter.bind(_this3, name)
	                        };
	                        return _react2.default.createElement(
	                            'li',
	                            { key: name },
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('input', (0, _extends3.default)({ className: 'new-todo', placeholder: 'What needs to be done?', autofocus: true }, this.val('text'), { onKeyDown: this.onKeyDown.bind(this) }))
	                    ),
	                    _react2.default.createElement(
	                        'section',
	                        { className: 'main' },
	                        _react2.default.createElement('input', { className: 'toggle-all', id: 'toggle-all', type: 'checkbox', onClick: this.toggleAll.bind(this) }),
	                        _react2.default.createElement(
	                            'ul',
	                            { className: 'todo-list' },
	...
	_reactDom2.default.render(_react2.default.createElement(App, { schema: _schema2.default }), document.getElementById('root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  ...
	  var ReactNativeOperationHistoryDevtool = __webpack_require__(110);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMDebugTool = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Bool = exports.Text = exports.Number = exports.Integer = exports.String = undefined;
	...
	var makeType = function makeType(type) {
	  return function (length) {
	    return new _type2.default(type).length(length);
	  };
	};
	
	var String = exports.String = makeType('string');
	var Integer = exports.Integer = makeType('integer');
	var Number = exports.Number = makeType('number');
	var Text = exports.Text = makeType('text');
	var Bool = exports.Bool = makeType('boolean');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(10)
	  ...
	  , each           = __webpack_require__(270)(0)
	  , DESCRIPTORS    = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _queryBuilder = __webpack_require__(281);
	
	var _queryBuilder2 = _interopRequireDefault(_queryBuilder);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var MoonLight = function (_Component) {
	    (0, _inherits3.default)(MoonLight, _Component);
	
	    function MoonLight(props) {
	        (0, _classCallCheck3.default)(this, MoonLight);
	
	        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(MoonLight).call(this, props));
	
	        (0, _keys2.default)(_this.props.schema).forEach(function (name) {
	            return _this[name] = new _queryBuilder2.default(name, _this);
	        });
	        return _this;
	    }
	
	    (0, _createClass3.default)(MoonLight, [{
	        key: 'val',
	        value: function val(name) {
	            ...
	            return {
	                onChange: function onChange(e) {
	                    return _this2.setState((0, _defineProperty3.default)({}, name, e.target.value));
	                },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _asyncToGenerator2 = __webpack_require__(287);
	...
	var _class = function () {
	    function _class(schema, context) {
	    ...
	    (0, _createClass3.default)(_class, [{
	        ...
	        key: 'map',
	        value: function map(clb) {
	            return this.data.map(clb);
	        }
	    }, {
	        key: 'forEach',
	        value: function forEach(clb) {
	            return this.data.forEach(clb);
	        }
	    }, {
	        key: 'filter',
	        value: function filter(clb) {
	            return this.data.filter(clb);
	        }
	    }, {
	        key: 'every',
	        value: function every(clb) {
	            return this.data.every(clb);
	        }
	    }, {
	        key: 'toModel',
	        value: function toModel(item) {
	            var _this = this;
	            ...
	            keys.forEach(function (name) {
	                newItem.__defineGetter__(name, function () {
	                    return item[name];
	                });
	                newItem.__defineGetter__('isEdit', function () {
	                    return item.isEdit;
	                });
	                newItem.__defineSetter__('isEdit', function (value) {
	                    item.isEdit = value;
	                    _this.context.forceUpdate();
	                });
	
	                newItem.__defineSetter__(name, function (value) {
	                    item[name] = value;
	                    _this.context.forceUpdate();
	                });
	        ...
	        key: 'beforeExec',
	        value: function beforeExec(data) {
	            var _this2 = this;
	            ...
	            switch (this.query.type) {
	                ...
	                case 'update':
	                    this.data = this.data.map(function (item) {
	                        if (item.id === _this2.query.query.fields.id) {
	                            item = _this2.query.query.fields;
	                        }
	                        return item;
	                    });
	                    break;
	                ...
	                return _regenerator2.default.wrap(function _callee$(_context) {
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                return _context.abrupt('return', fetch('/query', {
	                                    method: 'POST',
	                                    body: (0, _stringify2.default)(this.query)
	                                }).then(function (d) {
	                                    return d.json();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _types = __webpack_require__(255);
	
	exports.default = {
	    todos: {
	        text: (0, _types.String)(30),
	        done: (0, _types.Bool)()
	    }
	};
